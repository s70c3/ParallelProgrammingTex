...
\usepackage{hyperref}
\usepackage{xurl}
\usepackage[font=normalsize,labelfont=it,justification=centering, figurewithin= none, tablewithin=none]{caption} %for customize caption
\usepackage{float} %for figure position
\usepackage{amsmath} %for math equations
\usepackage{tabularx}
\def\UrlBreaks{\do\/\do\-\do\_\do\%\do\.\do\#} %for cutting urls
...
%	\include{description} %incorrect year!!!
	\pagestyle{empty} %for empty page number

	\include{CoverTitlePage}
	\include{TitlePage}
