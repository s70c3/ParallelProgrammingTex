{ %section1_7
	...
	\end{figure}
	\par As you can see, the assignment operation was translated into two assembler instructions, which makes it impossible to safely parallelize such an operation.
